...
namespace MATH
{
	...
	void AngleVectors3444(const Vector & angles, Vector * forward, Vector * right, Vector * up);
	void AngleVectors(const Vector &angles, Vector *forward);
	void AngleVectorssss(const Vector &angles, Vector *forward, Vector *right, Vector *up);
	void AngleVectorsGay(const Vector &angles, Vector *forward);
	void AngleVectorsGay(const QAngle & angles, Vector * forward);
