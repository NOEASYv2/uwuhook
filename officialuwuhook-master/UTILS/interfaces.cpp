...
namespace INTERFACES
{
	...
	void InitInterfaces()
	{
		...
		enginesound = reinterpret_cast<IEngineSound*>(FindInterfaceEx("engine.dll", "IEngineSoundClient003"));
		...
		g_pPred = reinterpret_cast<CPrediction*>(FindInterface("client.dll", "VClientPrediction"));

		g_pGameMovement = reinterpret_cast<CGameMovement*>(FindInterface("client.dll", "GameMovement"));
